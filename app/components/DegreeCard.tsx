...
export default function DegreeCard({
  ...
  const glowClass =
    variant === 'highlight' ? 'glow-grain glow-grain-lg' : 'glow-grain';
  return (
    <div className={`${glowClass} min-h-[200px] sm:min-h-[250px] md:min-h-[300px] w-[300px] sm:w-[500px] md:w-[670px]`}>
      <div className="relative z-10 border-4 border-gray-500/50 rounded-2xl bg-black p-4 sm:p-6 md:p-8 overflow-hidden h-full">
        <div>
          ...
          <p className="text-gray-300 mt-3 sm:mt-4 text-sm sm:text-base md:text-lg">
            GPA: {gpa}
          </p>
