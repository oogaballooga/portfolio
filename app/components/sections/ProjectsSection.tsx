...
export default function ProjectsSection() {
  ...
  return (
    <div ref={sectionRef} className="relative w-full min-h-screen text-white">
      <div className="max-w-[110rem] mx-auto px-4 pt-12 pb-16 md:px-8 md:pt-24">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-[repeat(auto-fit,minmax(500px,1fr))]">
          {projects.map((p) => (
            <div
              key={p.id}
